    ...
    <div className="min-h-screen bg-border-1 ">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <div className="mt-4 text-2xl text-white">⏱️ {formatTime(timeRemaining)}</div>
        </div>
            ...
            <Card className="border border-border bg-card p-6 sticky top-4 shadow-md">
              ...
              <div className="mb-6">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-3xl text-white">₱{totalAmount.toLocaleString()}</span>
                </div>
              </div>

              <div className="bg-secondary/10 border border-secondary/30 rounded p-3 text-xs text-muted-foreground space-y-2">
                <p>
                  <span className="text-white">✓</span> Secure payment
                </p>
                <p>
                  <span className="text-white">✓</span> Instant confirmation
                </p>
                <p>
                  <span className="text-white">✓</span> Email verification
                </p>
              </div>
            </Card>
          </div>
